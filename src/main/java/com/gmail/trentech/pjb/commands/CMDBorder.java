	...
	public CommandResult execute(CommandSource src, CommandContext args) throws CommandException {
		...
		if(src.hasPermission("pjb.cmd.border.center")) {
			list.add(Text.builder().color(TextColors.GREEN).onHover(TextActions.showText(Text.of("Click command for more information ")))
					.onClick(TextActions.executeCallback(Help.getHelp("center"))).append(Text.of(" /border center")).build());
		}
		if(src.hasPermission("pjb.cmd.border.damage")) {
			list.add(Text.builder().color(TextColors.GREEN).onHover(TextActions.showText(Text.of("Click command for more information ")))
					.onClick(TextActions.executeCallback(Help.getHelp("damage"))).append(Text.of(" /border damage")).build());
		}
		if(src.hasPermission("pjb.cmd.border.diameter")) {
			list.add(Text.builder().color(TextColors.GREEN).onHover(TextActions.showText(Text.of("Click command for more information ")))
					.onClick(TextActions.executeCallback(Help.getHelp("diameter"))).append(Text.of(" /border diameter")).build());
		}
		if(src.hasPermission("pjb.cmd.border.generate")) {
			list.add(Text.builder().color(TextColors.GREEN).onHover(TextActions.showText(Text.of("Click command for more information ")))
					.onClick(TextActions.executeCallback(Help.getHelp("generate"))).append(Text.of(" /border generate")).build());
		}
		if(src.hasPermission("pjb.cmd.border.warning")) {
			list.add(Text.builder().color(TextColors.GREEN).onHover(TextActions.showText(Text.of("Click command for more information ")))
					.onClick(TextActions.executeCallback(Help.getHelp("warning"))).append(Text.of(" /border warning")).build());
		}
