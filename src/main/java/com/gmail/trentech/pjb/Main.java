...
public class Main {
	...
	public void onInitializationEvent(GameInitializationEvent event) {
		...
		Help borderCenter = new Help("center", "center", "Set the center coordinates of border")
		...
		Help borderDamage = new Help("damage", "damage", "Set the damage threshold and amount damage player takes")
		...
		Help borderDiameter = new Help("diameter", "diameter", "Set the diameter of border")
		...
		Help borderGenerate = new Help("generate", "generate", "Pre generate chunks inside border")
		...
		Help borderInfo = new Help("info", "info", "Show information of world border")
				.setPermission("pjb.cmd.border.info")
				.addUsage("/border info <world>")
				.addUsage("/b i <world>")
				.addExample("/border info MyWorld");
		
		Help borderWarning = new Help("warning", "warning", "Set the center coordinates of border")
